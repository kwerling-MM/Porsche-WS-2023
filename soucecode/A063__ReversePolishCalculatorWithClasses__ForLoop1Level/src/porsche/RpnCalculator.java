...
public class RpnCalculator {
    ...
    private List<Command> getCommand(String token)  throws Exception {
        ...
        switch (token.toUpperCase()) {
            ...
            case "I-1" ->   {   cmds.add( new CmdLoopIndex(1)  ); }
            case "I-2" ->   {   cmds.add( new CmdLoopIndex(2)  ); }
            case "I-3" ->   {   cmds.add( new CmdLoopIndex(3)  ); }
            case "I-4" ->   {   cmds.add( new CmdLoopIndex(4)  ); }
            case "I-5" ->   {   cmds.add( new CmdLoopIndex(5)  ); }
